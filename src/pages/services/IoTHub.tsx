...
import iotHero from "@/assets/images/IoT Hub.jpg";
import industrialIoT from "@/assets/images/Iot Hub/1- Industrial IoT & Smart Facilities.jpg";
import connectivity from "@/assets/images/Iot Hub/2- Connectivity & Device Management.jpg";
import dataPlatform from "@/assets/images/Iot Hub/3-Data Platform & Integration .jpg";
import analytics from "@/assets/images/Iot Hub/4- Analytics, Alerts & Predictive Maintenance.jpg";
...
const IoTHub: React.FC = () => {
  const { t, i18n } = useTranslation();
  const isArabic = i18n.language === "ar";
  const navigate = useNavigate();
  const data = t("iotHubPage", { returnObjects: true }) as any;
  const images = [industrialIoT, connectivity, dataPlatform, analytics];
    ...
    >
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[90vh] text-center overflow-hidden px-6 py-20 sm:px-10">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-primary/60 to-brand/60 opacity-70"></div>
        </div>
