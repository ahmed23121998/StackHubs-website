...
import trainingHero from "@/assets/images/ُTraining Hub.jpg";
import { useNavigate } from "react-router-dom";
import deliveryModels from "@/assets/images/Training Hub/Delivery Models Remote, Onsite & Blended.jpg";
import handsOnLabs from "@/assets/images/Training Hub/Hands-On Labs & Skill Verification.jpg";
import productTracks from "@/assets/images/Training Hub/Product Tracks & Custom Curriculum.jpg";
import programPortfolio from "@/assets/images/Training Hub/Program Portfolio IT & Soft-Skills.jpg";
...
const TrainingHubPage: React.FC = () => {
  ...
  const data = t("trainingHubPage", { returnObjects: true }) as any;
  const images = [deliveryModels, handsOnLabs, productTracks, programPortfolio];
